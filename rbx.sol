...
contract RBX {
    ...
    function enterRiceInfo(string memory _Manufacturer, string memory _Brand, string memory _Area,
    ...
    uint _Date, uint _Year, uint _Month, uint _Day, uint _Weight, uint _Price) public {
        incrementCount();
		AllRice[transactionCount] = RiceInfo(transactionCount, _Manufacturer, _Brand, _Area, _Status, _StatusRecieved, _StatusWeight,
        _Date, _Year, _Month, _Day, _Weight, _Price);
		RiceAll[_Date] = RiceInfo(transactionCount, _Manufacturer, _Brand, _Area, _Status, _StatusRecieved, _StatusWeight,
        _Date, _Year, _Month, _Day, _Weight, _Price);
    }
